...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#faf9f6] text-[#1c1917]">
      <aside className="flex w-64 flex-shrink-0 flex-col border-r border-[#e7e5e4] bg-white">
        <div className="px-6 py-6">
          <Link href="/" className="[font-family:var(--font-serif-display)] text-xl text-[#1c1917] hover:opacity-70 transition-opacity">Coast Admin</Link>
        </div>
        <AdminNav />
